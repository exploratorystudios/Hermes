...
1.  **Train Model on PC:**
    * Execute `trainer.py` with desired parameters. For optimal robustness to typos, use a high number of epochs (e.g., 50,000 or more).
    * Example: `trainer.py --epochs 75000 --lr 0.005 --output nn_model_data.txt --test`
